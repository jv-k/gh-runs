...
- **What is the hard maximum for the confirm threshold (R12)?** UNKNOWN. It must sit far enough below the reference repository's ~28,700 Runs that the protection still binds on a real Purge, but no number has been chosen.
