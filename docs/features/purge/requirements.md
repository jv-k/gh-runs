...
**The binding is not this requirement's to name.** [live-run-feed](../live-run-feed/requirements.md) R7 ships exactly two keybinding profiles and owns which key does what in each. R30 requires one keystroke and requires the modal to say which.
