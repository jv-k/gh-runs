...
8. **How is the cap labelled in a merged view?** "1,000 of ~18,258" is a per-repository label and the cap is per repository. Undecided what a Feed spanning ~26 repositories, an arbitrary subset of them capped, says in one line without lying.
